...
void foo()
{
	...
	stop_timer();
	std::cout << "The time of an epoch when batch=1 image trainng of LeNet5 cifar single is " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << std::endl;
