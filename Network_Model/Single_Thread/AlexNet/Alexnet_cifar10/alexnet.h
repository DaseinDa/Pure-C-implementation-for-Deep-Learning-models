...
#define LENGTH_FEATURE1_1	(LENGTH_FEATURE0 - LENGTH_KERNEL + 2*PADDING+1) //32
#define LENGTH_FEATURE1_2	(LENGTH_FEATURE1_1/2) //16

#define LENGTH_FEATURE2_1	(LENGTH_FEATURE1_2 - LENGTH_KERNEL +2*PADDING + 1) //16
#define	LENGTH_FEATURE2_2	(LENGTH_FEATURE2_1/2)  //8*8

#define LENGTH_FEATURE3_1	(LENGTH_FEATURE2_2 - LENGTH_KERNEL +2*PADDING+ 1) //8 8

#define LENGTH_FEATURE4_1	(LENGTH_FEATURE3_1 - LENGTH_KERNEL +2*PADDING+ 1)//8 8

#define MAXPOOL5_2_KERNEL 3
#define MAXPOOL5_2_STRIDE 2

#define LENGTH_FEATURE5_1	(LENGTH_FEATURE4_1 - LENGTH_KERNEL+2*PADDING+ 1)	//8 8
#define LENGTH_FEATURE5_2	((LENGTH_FEATURE5_1 - MAXPOOL5_2_KERNEL)/MAXPOOL5_2_STRIDE+ 1) //4 4
...
typedef struct Feature
{
	...
	double layer1_conv[LAYER1][LENGTH_FEATURE1_1][LENGTH_FEATURE1_1];//32
	double layer1_pool[LAYER1][LENGTH_FEATURE1_2][LENGTH_FEATURE1_2];//16

	double layer2_conv[LAYER2][LENGTH_FEATURE2_1][LENGTH_FEATURE2_1];//16
	double layer2_pool[LAYER2][LENGTH_FEATURE2_2][LENGTH_FEATURE2_2];//8
