...
void read_test(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_test("/home/jin/Network_model/LeNet-5_cifar10/data/cifar/cifar-10-batches-bin", limit, images, labels, func);
}
...
void read_training(std::size_t limit, Images& images, Labels& labels, Functor func) {
    read_training("/home/jin/Network_model/LeNet-5_cifar10/data/cifar/cifar-10-batches-bin", limit, images, labels, func);
}
...
void read_training_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_training_categorical("/home/jin/Network_model/LeNet-5_cifar10/data/cifar/cifar-10-batches-bin", limit, images, labels);
}
...
void read_test_categorical(std::size_t limit, Images& images, Labels& labels) {
    read_test_categorical("/home/jin/Network_model/LeNet-5_cifar10/data/cifar/cifar-10-batches-bin", limit, images, labels);
}
