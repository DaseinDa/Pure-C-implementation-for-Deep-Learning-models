...
void TrainBatch(LeNet5 *lenet, image *inputs, uint8 *labels, int batchSize)
{
	...
	int i = 0;
	// int right=0;
   	// ofstream   myfile("lenet5_parallel_cifar10_batch1000_training.txt",ios::out|ios::app);
	// start_timer_lenet();
#pragma omp parallel for
	...
	// stop_timer_lenet();	
	// std::cout << "The time of a batch of 1 image trainng of LeNet5 parallel is " << std::chrono::duration_cast<std::chrono::milliseconds>(duration_lenet).count() << std::endl;
