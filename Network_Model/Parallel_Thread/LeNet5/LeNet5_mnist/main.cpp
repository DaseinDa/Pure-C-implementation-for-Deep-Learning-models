...
void foo()
{
	...
	stop_timer();
	std::cout << "The time of an epoch when batch=1000s image trainng of LeNet5 parallel is: " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << std::endl;
