...
// }
stop_timer();
	std::cout << "The time of an epoch when batch=300 image trainng of ResNet mnist parallel is " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << std::endl;
