...
void TrainBatch(ResNet18 *resnet, image *inputs, uint8 *labels, int batchSize)
{
	...
	int i = 0;
	int right=0;
	ofstream myfile("res18_parallel_mnist_batch1000_6000_training.txt",ios::out|ios::app);
	start_timer_res18();
#pragma omp parallel for
	...
	stop_timer_res18();	
	std::cout << "The time of a batch of 1 image trainng of Res18 parallel is " << std::chrono::duration_cast<std::chrono::milliseconds>(duration_res18).count() << std::endl;
