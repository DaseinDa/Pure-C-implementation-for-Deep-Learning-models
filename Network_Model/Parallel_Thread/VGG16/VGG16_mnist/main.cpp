...
void foo()
{
	...
	stop_timer();
	std::cout << "The time of an epoch when batch=100 image trainng of ResNet18 parallel is: " << std::chrono::duration_cast<std::chrono::milliseconds>(duration).count() << std::endl;
// }
